...
n_trees = 500
n_feat = selected_f(10940)  # features selecleted
...
for r in range(3):
    ...
    for l in range(10):
        ...
        e62.append(m62.score(X_features_test6, Y[test_indices]))
        e61.append(w6)
        ...
        pre6 = m62.predict(X_features_test5)
